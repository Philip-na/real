...
export function getRandomName(): string {
    const adjectives = [
        "Serene", "Elegant", "Sunny", "Modern", "Charming", "Cozy", "Luxury",
        "Grand", "Tranquil", "Vibrant", "Peaceful", "Hidden", "Majestic", "Royal"
    ];
    const nouns = [
        "Villa", "Estate", "Cottage", "Retreat", "Haven", "Residence",
        "Manor", "Oasis", "Loft", "Apartments", "Suites", "Homes", "Terrace"
    ];
...
export function getRandomDescription(): string {
    const descriptions = [
        "A beautiful property with scenic views and modern finishes.",
        "Perfect for families looking for comfort and convenience.",
        "Located in a peaceful neighborhood with great access to amenities.",
        "A stylish home offering luxury living and privacy.",
        "Ideal for anyone seeking serenity and natural beauty.",
        "Spacious interiors, bright rooms, and elegant design.",
        "A modern property designed for comfort and functionality.",
        "Enjoy a blend of traditional charm and contemporary luxury.",
        "A hidden gem with lush surroundings and premium features.",
        "Designed with sophistication and relaxation in mind.",
    ];
